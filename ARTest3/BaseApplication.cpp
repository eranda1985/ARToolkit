...
bool BaseApplication::setup(void)
{
    ...
    newImage.load("Dirt.jpg", "Popular");
...
bool BaseApplication::frameRenderingQueued(const Ogre::FrameEvent& evt)
{
    ...
    if (!mTrayMgr->isDialogVisible())
    {
		...
		Ogre::Vector3 position = Ogre::Vector3(gl_para[12], -gl_para[13], -gl_para[14]); 

		Ogre::Vector3 xr = Ogre::Vector3((gl_para[0]), -(gl_para[1]), -(gl_para[2])); 
		Ogre::Vector3 yr = Ogre::Vector3(( gl_para[4]), -(gl_para[5]), -(gl_para[6])); 
		Ogre::Vector3 zr = Ogre::Vector3(( gl_para[8]), -(gl_para[9]), -(gl_para[10])); 
		...
		//Ogre::Quaternion x90 = Ogre::Quaternion(Ogre::Radian(Ogre::Degree(90.0f)), Ogre::Vector3::UNIT_X); 
